...
public class uMessage {
    ...
    private static final Supplier<Dictionary<NGram, Dictionary<AlphabeticString, Integer>>> NEW_OUTER = NGramTester.hashtableConstructor(NGramTester.avlTreeConstructor());;
    private static final Supplier<Dictionary<AlphabeticString, Integer>> NEW_INNER = NGramTester.hashtableConstructor(NGramTester.avlTreeConstructor());;
